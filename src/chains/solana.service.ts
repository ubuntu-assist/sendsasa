...
export class SolanaService {
  keypairFromSeed(seedHex: string) { return keypairFromSeed(seedHex) }
  getSOLBalance(address: string) { return getSOLBalance(address) }
  getSPLTokenBalance(address: string, mintAddress: string) { return getSPLTokenBalance(address, mintAddress) }
  getAllBalances(address: string) { return getAllBalances(address) }
  sendSOL(seedHex: string, to: string, amount: number) { return sendSOL(seedHex, to, amount) }
  sendUSDC(seedHex: string, to: string, amount: number) { return sendUSDC(seedHex, to, amount) }
  sendUSDT(seedHex: string, to: string, amount: number) { return sendUSDT(seedHex, to, amount) }
  sendEURC(seedHex: string, to: string, amount: number) { return sendEURC(seedHex, to, amount) }
  isValidSolanaAddress(address: string) { return isValidSolanaAddress(address) }
}
