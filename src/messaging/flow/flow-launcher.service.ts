...
const CRYPTO_SWAP_FLOW_ID = config.FLOW_ID_CRYPTO_SWAP
...
export class FlowLauncherService {
      ...
      interactive: {
        ...
        action: {
          ...
          parameters: {
            flow_message_version: '3',
            flow_token: flowToken,
            flow_id: CRYPTO_SWAP_FLOW_ID,
            flow_cta: 'Start Swap',
            mode: 'published',
            flow_action: 'navigate',
            flow_action_payload: { screen: 'SWAP_ASSETS', data: {} },
          },
        },
      },
    })
  ...
  launchCryptoSwapFlow(user: IUser) {
    return FlowLauncherService.launchCryptoSwapFlow(user)
  }
}
