...
const DealSchema = new mongoose.Schema(
  {
    ...
    stellarEscrowContractId:  { type: String, sparse: true },
    stellarLockTxHash:        { type: String, sparse: true },
    stellarReleaseTxHash:     { type: String, sparse: true },
    stellarRefundTxHash:      { type: String, sparse: true },
